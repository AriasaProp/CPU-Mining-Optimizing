...
public class StratumWorkBuilder {
  ...
  public MiningWork buildMiningWork() throws RuntimeException {
    ...
    return new StratumMiningWork(
        work_data, diff2target(this._difficulty / 65536.0), this._notify.job_id, xnonce2_str);
  }
...
// [2013-12-21 17:07:00] < {"error": null, "id": 1, "result": [["mining.notify",
// "ae6812eb4cd7735a302a8a9dd95cf71f"], "f801d02f", 4]}
...
// [2013-12-21 17:07:00] < {"params": ["8bf",
// "8e50f956acdabb3f8e981a4797466043021388791bfa70b1c1a1ba54a8fbdf50",
