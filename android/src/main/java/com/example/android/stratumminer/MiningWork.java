...
public class MiningWork {
  ...
  public static final int INDEX_OF_PREVHASH = 4; // 32byte
  public static final int INDEX_OF_MARKERTOOT = INDEX_OF_PREVHASH + 32; // 32byte
  public static final int INDEX_OF_NTIME = INDEX_OF_MARKERTOOT + 32; // 4byte
  public static final int INDEX_OF_NBIT = INDEX_OF_NTIME + 4; // 4byte
}
