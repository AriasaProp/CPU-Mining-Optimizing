...
public class TestStratumMiningConnection implements IMiningConnection {
  ...
  static final Dataset[] data = {
    ...
    new Dataset(
        ...
        /*NT   */ "{\"params\": [\"e4c\","
                      ...
                      + " \"0d2f7374726174756d506f6f6c2f000000000140ace4dfd40100001976a914d2468dfebad54e0c5deac5a27bea66f79a61228788ac00000000\","
                      + " [\"00a3da053c03e6d86a3d0c8b2e2f468dcdf43029c0f7e5b6fa2a148268cdea65\","
                      + " \"f64d6bb298faf383a8e690e8cc13af27b932b7209286a3f89faff96b75d8ab28\","
                      ...
                      + " \"7aa88a90e04ffbfca7b703c2ca2ea8429ee8b1ff9feab5497d3ef1449f8f6bf2\","
                      + " \"ed5c9dde6b5eab2e2134dde3accf2e09ddec81f7759a3b94c48238b547f8fbce\"],"
                      + " \"00000001\", \"1c23ccc0\", \"52b7a1a9\", false], \"id\": null,"
                      + " \"method\": \"mining.notify\"}",
        /*ST   */ "{\"params\": [64], \"id\": null, \"method\": \"mining.set_difficulty\"}",
        /*NONCE*/ 0x00012879),
    // String
    // WORK_DATA="";
    ...
    new Dataset(
        ...
        /*NT   */ "{\"params\": [\"5138\","
                      ...
                      + " [], \"00000001\", \"1d050327\", \"52d52f15\", true], \"id\": null,"
                      + " \"method\": \"mining.notify\"}",
    ...
    new Dataset(
        ...
        /*NT   */ "{\"params\": [\"4dd9\","
                      ...
                      + " \"162f6e79616e2e6c75636b796d696e6572732e636f6d2f0000000001801edec8000000001976a914f7a5ba85e33ae57ce35ba539cafeb7a2eabe8ceb88ac00000000\","
                      + " [], \"00000001\", \"1d14d81f\", \"52dbacab\", true], \"id\": null,"
                      + " \"method\": \"mining.notify\"}",
        /*ST   */ "{\"params\": [16], \"id\": null, \"method\": \"mining.set_difficulty\"}",
        /*NONCE*/ 0x0003b038)
  };
  ...
  private long submit(int i_nonce, String i_user, String i_jobid, String i_nonce2, String i_ntime) {
    ...
    // {"method": "mining.submit", "params": ["xxxxx", "e4c", "00000000", "52b7a1a9", "79280100"],
    // "id":4}
    String s =
        "{\"id\": "
            + this._id
